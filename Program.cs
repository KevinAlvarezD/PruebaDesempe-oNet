...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "PruebaDesempeño", Version = "v1" });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "PruebaDesempeño API V1");
